...
object PimpMyLibrary extends App {
  ...
  implicit class ReachInt2(val value: Int){
    def ntimes(function: ()=>Unit): Unit = (1 to value).foreach(_ => function())

    def /(list: List[Int]): List[Int] = (1 to value).flatMap(_ => list).toList
  }
